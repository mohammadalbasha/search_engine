import searchServiceAfterClustering as search
import ir_datasets
antique_dataset = ir_datasets.load("antique/test")
...
retrieved_docs = {}
for query in antique_dataset.queries_iter():
